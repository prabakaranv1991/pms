...
class Call(TimeStampedModel):
    ...
    bank = models.CharField(max_length=100, choices=[('icici', 'ICICI'), ('hdfc', 'HDFC'), ('sbi', 'SBI'), ('kvb', "KVB"), ('axis', "Axis"), ('kotak', "KOTAK"), ('indian_bank', 'INDIAN BANK'), ('other', 'OTHERS'), ('bajaj', 'BAJAJ')])
    other_bank = models.CharField(max_length=100, null=True, blank=True)
